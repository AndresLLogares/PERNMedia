...
const NavbarOthers = () => {
  ...
  const handleSubmitChange = (event) => {
    ...
    if (userSearch === "") {
      ...
      allusers.findIndex(
        (item) =>
          item.full_name.toLowerCase() === userSearch.toLocaleLowerCase()
      ) === -1
    ) {
      return toast.error("This is not a valid name");
    }
    let uuid = allusers.filter(
      (item) => item.full_name.toLowerCase() === userSearch.toLocaleLowerCase()
    );
        ...
        <Zoom className={styles.zoom}>
          <div className={styles.sortLinks}>
            ...
            <div className={styles.eachLink}>
              <form onSubmit={handleSubmitChange} className={styles.form}>
                <div className={styles.sortAutoInput}>
                  ...
                  <div
                    className={
                      auto.length === 0 ? styles.noneAuto : styles.sortAuto
                    }
                  >
                    {auto &&
                      auto.slice(0, 5).map((item, index) => (
                        <div
                          onClick={() => handleAutoSearch(item.uuid)}
                          key={index}
                          className={styles.eachAuto}
                        >
                          <img
                            src={
                              item.photo_profile
            ...
            <div className={styles.eachLink}>
              ...
              >
                <button className={styles.buttonLinks}>
                  <EmojiLaughingFill className={styles.iconsLinks} />
                  AboutMe
                </button>
              </Link>
            </div>
            <div className={styles.eachLink}>
              ...
              >
                <button className={styles.buttonLinks}>
                  <Home className={styles.iconsLinks} />
                  Home
                </button>
              </Link>
            </div>
            <div className={styles.eachLink}>
              ...
              >
                <button className={styles.buttonLinks}>
                  <Profile className={styles.iconsLinks} />
                  Profile
                </button>
              </Link>
            </div>
            <div className={styles.eachLink}>
              ...
              >
                <button className={styles.buttonLinks}>
                  <UserFriends className={styles.iconsLinks} />
                  Friends
                </button>
              </Link>
            </div>
            <div className={styles.eachLink}>
              ...
              >
                <button className={styles.buttonLinks}>
                  <Message className={styles.iconsLinks} />
                  Messages
                </button>
              </Link>
            </div>
            <div className={styles.eachLink}>
              <button onClick={handleLogOut} className={styles.buttonLinks}>
                <LogOut className={styles.iconsLinks} />
                Logout
              </button>
            </div>
          </div>
