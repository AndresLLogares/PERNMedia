                      ...
                      <div className={styles.popUpDelete}>
                        <Zoom className={styles.zoomPopUp}>
                          <p className={styles.question}>
                            Are you sure that you want to delete this education?
                          </p>
              ...
              <Zoom className={styles.zoomPopUp}>
                ...
                <form onSubmit={handleSubmitEducation} className={styles.form}>
                  <label className={styles.label}>
                    <Institution className={styles.iconButtonsForm} /> Institute
                  </label>
                  <input
                  ...
                  />
                  <label className={styles.label}>
                    <Certificate className={styles.iconButtonsForm} /> Degree
                    obtained
                  </label>
                  <input
                    onChange={handleInputChange}
                  ...
                  />
                  <label className={styles.label}>
                    <CalendarDateFill className={styles.iconButtonsForm} />{" "}
                    Start date
                  </label>
                  <input
                    onChange={handleInputChange}
