...
const Jobs = () => {
    ...
    const handleDeleteJobs = async () => {
        await axios.post(URL + 'deletejobs', {
            email: emailUser.toLocaleLowerCase(),
            id: idToDelete
        })
            .then(response => {
                                    ...
                                    {popUpDelete ?
                                        ...
                                        <div className={styles.popUpDelete}>
                                            <Zoom className={styles.zoomPopUp} >
                                                <p className={styles.question}>Are you sure that you want to delete this job?</p>
                                                <div className={styles.sortButtonsPopUp}>
                                                    <button className={styles.buttonBack} onClick={handleDeleteJobs} >Yes</button>
                        ...
                        <div className={styles.popUp}>
                            <Zoom className={styles.zoomPopUp} >
                                ...
                                <form onSubmit={handleSubmitJobs} className={styles.form}>
                                    <label className={styles.label} ><PositionForward className={styles.iconButtonsForm} /> Job Position</label>
                                    <input
                                        ...
                                        type="text"
                                    />
                                    <label className={styles.label}><Work className={styles.iconButtonsForm} />Employment Type</label>
                                    <input
                                        onChange={handleInputChange}
                                        className={styles.input}
                                        name='employmenttype'
