...
const Information = () => {
    ...
    let white = 'https://res.cloudinary.com/andreslogares/image/upload/v1625771261/PlantillasPokemon/White_zrhnaf.jpg';
    ...
    const handleSubmitFile = async (event) => {
        ...
        await axios.post(URL + 'addothers', {
    ...
    const handleDeleteFile = async () => {
        await axios.post(URL + 'deleteother', {
            email: emailUser.toLocaleLowerCase(),
            id: idToDelete
        })
            .then(response => {
    ...
    const handleSubmitInfo = async (event) => {
        ...
        await axios.post(URL + 'addcountry', {
            email: emailUser.toLocaleLowerCase(),
                ...
                <Zoom className={styles.zoomWidht} >
                    <div className={styles.firstColumn}>
                        ...
                        {edit ?
                            ...
                            :
                            <Fragment>
                                <p className={styles.eachInfo} >Select your Region and Country</p>
                                ...
                                <button onClick={handleRegionButton} className={styles.buttonBack} ><SearchLocation className={styles.iconButtons} /></button>
                                {countries.length === 0 ?
                                    ...
                                    <Fragment>
                                        ...
                                        <button onClick={handleCountryButton} className={styles.buttonBack} ><SearchLocation className={styles.iconButtons} /></button>
                                    </Fragment>
                                }
                                <div className={styles.containerFlag}>
                                    <img src={cities.length != 0 ? cities.data.flag : white} alt='' className={styles.flag} />
                                </div>
                                <div className={styles.containerSave}>
                                    <button onClick={handleSubmitInfo} className={styles.buttonBookPop} ><Save className={styles.iconBook} /></button>
                                </div>
                            </Fragment>
                        }
                    </div>
                ...
                <Zoom className={styles.zoomWidthSecond} >
                    <div className={styles.secondColumn}>
                        {edit ?
                            ...
                            :
                            <Fragment>
                                <p className={styles.eachInfo} >You can add other information here, like images and links</p>
                                <button onClick={handlePopUp} className={styles.buttonBook} ><BookAdd className={styles.iconBook} /></button>
                            </Fragment>
                        }
                        <div className={styles.containerOthers}>
                            {user.others && user?.others.map((item, index) => (
                                <Fragment key={index} >
                                    <div className={styles.sortOthers}>
                                        ...
                                        {popUpDelete ?
                                            ...
                                            <div className={styles.popUpDelete}>
                                                <Zoom className={styles.zoomPopUp} >
                                                    <p className={styles.eachInfoOthers}>Are you sure that you want to delete this post?</p>
                                                    <div className={styles.sortButtonsPopUp}>
                                                        <button className={styles.buttonBack} onClick={handleDeleteFile} >Yes</button>
                                        ...
                                        <a className={styles.eachInfoOthers}
                                            style={{ textDecoration: 'none' }}
                                            target="_blank"
                                            href={item.url}
                                        ><div className={styles.divUrl}>{item.url}</div> </a>
                                        <Skeleton style={{ marginTop: '3%' }} width={'80%'} />
                                        <Skeleton width={'80%'} animation={false} />
                                        <Skeleton style={{ marginBottom: '3%' }} width={'80%'} animation="wave" />
                                        <div className={styles.sortFileUSer}>
                                            <img className={styles.imageFile} src={item.image} alt='' />
                                        </div>
                                    </div>
                                </Fragment>
                            ))}
                    ...
                    <div className={styles.popUp}>
                        <Zoom className={styles.zoomPopUp} >
                            <div className={styles.buttonX}>
                                <button onClick={handlePopUp} className={styles.buttonBack} ><WindowClose className={styles.iconButtons} /></button>
                            </div>
                            <form onSubmit={handleSubmitFile} className={styles.form}>
                                <div className={styles.separateLabels}>
                                    ...
                                    <div className={styles.eachLabel}>
                                        <label
                                            className={styles.label} >
                                            <Link className={styles.iconsForm} />Link
                                        </label>
                                        <input
                                            type="text"
                                            value={myURL}
                                ...
                                <div className={styles.sortButtonFile}>
                                    <button type="button" onClick={handleInputFile} className={styles.buttonBookPop} >
                                        <FileEarmarkPlusFill className={styles.iconBook} /></button>
                                </div>
                                <input onChange={HandleAddFile} type="file" style={{ display: 'none' }} id="filePop" name="filePop" />
                                <div className={styles.separateLabels}>
                                    <div className={styles.eachLabel}>
                                        <div className={styles.sortFile}>
                                            <img className={styles.imageFile} alt='' src={file !== '' ? file : ''} />
                                        </div>
                                    </div>
                                    <div className={styles.eachLabel}>
                                        <div className={styles.sortFile}>
                                ...
                                <button type='submit' className={styles.buttonBookPop} ><Save className={styles.iconBook} /></button>
                            </form>
                        </Zoom>
                    </div>
                }
