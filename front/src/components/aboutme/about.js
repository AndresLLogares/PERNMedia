            ...
            <div className={styles.sortMe}>
              <Zoom className={styles.zoom}>
                <p className={styles.me}>
                  Hi, i'm Andrés Luis Logares, the person behind this website,
                  you can contact me by the next ways
                </p>
              </Zoom>
            </div>
                ...
                <div className={styles.sortLinks}>
                  ...
                  >
                    <p className={styles.links}>
                      <Linkedin className={styles.iconLinks} />
                      Linkedin{" "}
                    </p>
                  </a>
                  <a
                  ...
                  >
                    <p className={styles.links}>
                      <Github className={styles.iconLinks} /> Github
                    </p>
                  </a>
                  <a
                    style={{ textDecoration: "none" }}
                  ...
                  >
                    <p className={styles.links}>
                      <Portfolio className={styles.iconLinks} /> Portfolio
                    </p>
                  </a>
                  <div className={styles.eachLink}>
                    <p className={styles.links}>
                      <Email className={styles.iconLinks} />
