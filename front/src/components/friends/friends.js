...
const Friends = () => {
  ...
  const handleMesage = () => {
    window.location.href = `https://pinkbio.netlify.app/Messages`;
  };
      ...
      <div className={styles.sortTitleFriends}>
        <Zoom className={styles.zoom}>
          <div className={styles.boxFriends}>
            <p className={styles.titleFrinds}>
              These are your friends {user.fullname}
            </p>
          </div>
        </Zoom>
      </div>
                  ...
                  {item.request ? (
                    <Zoom className={styles.zoomFriends}>
                      <div className={styles.eachFriend}>
                        <img
                          src={!item.image ? noProfile : item.image}
                          alt=""
                        ...
                        <div className={styles.sortButton}>
                          ...
                          >
                            <CheckCircle className={styles.icons} /> Accept
                          </button>
                          <button
                            onClick={() => handlePopUpDelete(item.uuid)}
                            className={styles.buttonFriend}
                          >
                          ...
                          <div className={styles.popUpDelete}>
                            <Zoom className={styles.zoomPop}>
                              ...
                              <div className={styles.sortButtonsPopUp}>
                                ...
                                <button
                                  onClick={() => setPopUpRemove(!popUpRemove)}
                                  className={styles.buttonBack}
                                >
                                  No
                                </button>
                      ...
                      <div className={styles.eachFriend}>
                        ...
                        <div className={styles.sortButton}>
                          <button
                            ...
                            className={styles.buttonFriend}
                          >
                            <Send className={styles.icons} /> Send Message
                          </button>
                          <button
                            onClick={() => handleLinkProfile(item.frienduuid)}
                            className={styles.buttonFriend}
                          >
                            <Profile className={styles.icons} /> See Profile
                          </button>
                        </div>
                        <div className={styles.sortRemove}>
                          <button
                            ...
                            onClick={() => handlePopUpDelete(item.uuid)}
                          >
                            <WindowClose className={styles.iconsSmall} />
                          </button>
                        </div>
                        {popUpRemove ? (
                          <div className={styles.popUpDelete}>
