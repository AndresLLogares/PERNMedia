        ...
        await axios.post(URL + 'reset', {
            ...
            .then(async (response) => {
                if (response.data.success === true) {
                    ...
                    return setTimeout(() => window.location.href = 'https://pinkbio.netlify.app/', 1000)
                }
                else {
                    ...
                    <div className={styles.boxReset}>
                        ...
                        <form onSubmit={handleSubmitChange} className={styles.form}>
                            ...
                            <Zoom className={styles.zoom} >
                                <label
                                    className={styles.label} >
                                    <Password className={styles.iconsForm} />New Password
                                </label>
                                <input
                                    type='password'
                                    name='password'
                            ...
                            <Zoom className={styles.zoom} >
                                <div className={styles.sortButton}>
                                    <button type='submit' className={styles.button}>Reset<ArrowRightCircle className={styles.iconsFormLog} /></button>
                                </div>
                            </Zoom>
                        </form>
                    </div>
